...
<svelte:head>
	<title>Iniciar Sesión — FamiPass Admin</title>
</svelte:head>
...
<div class="flex items-center justify-center min-h-screen p-4 bg-(--bg-base) relative overflow-hidden">
	...
	<!-- Card -->
	<div class="w-full max-w-md p-8 sm:p-10 card">
		...
		<p class="mt-6 text-center text-xs text-(--text-muted)">
			Solo usuarios con rol de <strong>Administrador</strong> pueden acceder a este panel.
		</p>
	</div>
</div>
