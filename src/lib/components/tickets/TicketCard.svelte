...
>
	<!-- Header strip -->
	<div class="px-5 pt-5 pb-4 bg-linear-to-br from-(--accent) to-(--accent-hover)">
	...
	<div class="flex items-center px-4 -my-px z-10">
		<div class="w-4 h-4 rounded-full bg-(--bg-base) border border-(--border) shrink-0 -ml-6"></div>
		<div class="flex-1 border-t-2 border-dashed border-(--border) mx-2"></div>
		<div class="w-4 h-4 rounded-full bg-(--bg-base) border border-(--border) shrink-0 -mr-6"></div>
	</div>
	...
	<div class="px-5 py-5 flex flex-col items-center">
		...
		{:else}
			<div class="w-45 h-45 flex flex-col items-center justify-center border-2 border-dashed border-(--border) rounded-xl">
